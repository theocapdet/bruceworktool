...
public class FileProcesser {
    ...
    public void writeFile(File f, Socket socket) throws IOException {
        ...
        oos.writeLong(total);
        oos.writeLong(count);
        System.out.println("write file size==>" + total);
    ...
    public void readFile(String filefolder, Socket socket) throws IOException, ClassNotFoundException {
        ...
        if (header.equals(TransProtocol.FILE_H)) {
            ...
            System.out.println("read file size===>" + total);
            ...
            byte[] buffer;
            FileOutputStream fos = new FileOutputStream(new File(filefolder + File.separator + filename));
            if (header.equals(TransProtocol.FILE_H)) {
